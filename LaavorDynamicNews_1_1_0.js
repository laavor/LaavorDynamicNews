function LaavorDynamicNews(democracy, hilmarsdottir) {
    ...
    if (__lauytegdfdr !== undefined && __lauytegdfdr !== null) {
		...
		if(Bar_asjdhkjashdkj_40thol_jahahahah_di !== undefined && Bar_asjdhkjashdkj_40thol_jahahahah_di !== null)
		{
			...
			var _42_42_42_Star_Galactica_zzzz_ceacaracatra_  = [];
			for (var _Grays_78788888_tone_Caprica_  = 0; _Grays_78788888_tone_Caprica_ < Bar_asjdhkjashdkj_40thol_jahahahah_di.length; _Grays_78788888_tone_Caprica_++) {
				_42_42_42_Star_Galactica_zzzz_ceacaracatra_.push(Bar_asjdhkjashdkj_40thol_jahahahah_di[_Grays_78788888_tone_Caprica_].cloneNode(true));
			}
	
			setTimeout(function () {
				RosettaStone(1, _42_42_42_Star_Galactica_zzzz_ceacaracatra_, z40_index_boston_robot___ksakldaasdasdasd, _civil_vancamp, __lauytegdfdr);
			}, _civil_vancamp);
		}
		else
		{
...
function RosettaStone(liberte_F, _7_40_280_lalala_Grea_t_Charter, numberVisibleItems, fraternite_F, _42_another_42__Goa_uld) {
    var _15_jun_1215 = 0;
    var democrazia_1946 = liberte_F;
    var demo_athens_kracia = [];
    var _0_0_17_b_1_i_8_a = 0;

    _42_another_42__Goa_uld.innerHTML = "";

    while (_0_0_17_b_1_i_8_a < _7_40_280_lalala_Grea_t_Charter.length) {
        if (liberte_F >= _7_40_280_lalala_Grea_t_Charter.length) {
            break;
        }
        ...
        if (_15_jun_1215 < numberVisibleItems) {
			_42_another_42__Goa_uld.appendChild(_7_40_280_lalala_Grea_t_Charter[democrazia_1946]);
            _7_40_280_lalala_Grea_t_Charter[democrazia_1946].style.display = "block";
        }
        else {
            _7_40_280_lalala_Grea_t_Charter[democrazia_1946].style.display = "none";
        }

        democrazia_1946++;
        if (democrazia_1946 === _7_40_280_lalala_Grea_t_Charter.length) {
            democrazia_1946 = 0;
        }
    ...
    if (liberte_F + 1 < _7_40_280_lalala_Grea_t_Charter.length) {
    ...
    setTimeout(function () {
        RosettaStone(_lasklasdlkjasdlk_jkhasdkjasdkjh_1783, _7_40_280_lalala_Grea_t_Charter, numberVisibleItems, fraternite_F, _42_another_42__Goa_uld);
    }, fraternite_F);
}
